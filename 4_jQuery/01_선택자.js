...
$(function () {
    ...
    // 제이쿼리 방식
    $("h5").css("color", "skyblue").css("background-color", "navy");
    ...
    // $(".item").css("color", "white").css("background-color", "indigo");
    ...
    $("#div1 input[type!=text]").css("background", "yellow");

    // 6. 입력 양식 선택자
    // $("#div2 input[type=text]").css("background-color", "pink");
