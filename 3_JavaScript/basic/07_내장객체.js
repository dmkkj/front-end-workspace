function btn1() {
  ...
  console.log("절대값 : ", Math.abs(-8.87878787)); // 8.878787
}
...
function btn4() {
  const now = new Date(); // Date 객체는 new 사용하여 객체 생성해야 함
  console.log(now);

  console.log("년 : ", now.getFullYear()); // 2024
  console.log("월 : ", now.getMonth() + 1); // 5, 0 ~ 11. +1 해줘야 함
...
function btn8() {
  ...
  location.reload(); // 새로고침. location은 브라우저를 작동시킬 수 있음
