    ...
    */
    ...
    return (
      <>
        ...
        <p>Minutes : <input type="number" ref={changeMinutesRef} onChange={Minutes} value={text}/></p>
        <p>Hours : <input type="number" ref={changeHoursRef} onChange={Hours} value={Math.round(text / 60)} placeholder="Hours"/></p>
